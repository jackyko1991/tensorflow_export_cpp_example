...
int main(int argc, char* argv[]) {
  ...
  /* TODO: Change these paths to your test image, your freezed_graph and the labels file,
  you can also input your test image via argument when calling your runnable built file.
  */
  string image = "/Users/HANEL/tensorflow/git/tensorflow/tensorflow/examples/ccifar/data/251.png";
  string graph =
      "/Users/HANEL/tensorflow/git/tensorflow/tensorflow/examples/ccifar/data/output_graph.pb";
  string labels =
      "/Users/HANEL/tensorflow/git/tensorflow/tensorflow/examples/ccifar/data/imagenet_comp_graph_label_strings.txt";
  int32 input_width = 32;
  int32 input_height = 32;
  int32 input_mean = 128;
  int32 input_std = 128;

  // TODO: These names are important, they whould be the same in your code for the node name!
